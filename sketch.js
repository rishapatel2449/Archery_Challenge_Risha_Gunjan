...
if (gameState == "play" || gameState == "level2" || gameState == "gameOver" || gameState=="win") {
    fill("black");
    textSize(40);
...
function spawnArrows() {
    ...
    arrow = createSprite(player.x + 10,442, 20, 20);
    ...
    if(gameState=="level2"){
        arrow = createSprite(player.x + 10,342, 20, 20);
    arrow.addImage(arrow_img);
    arrow.scale = 0.2;
